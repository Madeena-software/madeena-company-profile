...
|--------|----------|-------|
| `DOCKERHUB_USERNAME` | ✅ | Docker Hub account used for pushes and pulls |
...
5. Run `deploy-swarm.yml` for each production deployment.
...
```
Internet -> Host Nginx (443/80) -> Docker Swarm Ingress -> app_nginx:{{APP_PORT}} -> app:9000
```
